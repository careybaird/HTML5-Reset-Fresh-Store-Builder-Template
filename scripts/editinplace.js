...
EditInPlace.defaults = {
	...
	saving:					'<span id="#{saving_id}" class="#{saving_class}" style="display: none;"><img src="/icons/common_loading.gif" /></span>',
	...
	start_select_form:		'<select id="#{id}_edit" name="#{id}_edit" class="eip_selectfield"> <br />',
	...
	stop_form:				'</span>',
	form_buttons:			'<span class="eip_buttons" style="display: #{display_buttons};"><input type="button" value="#{savebutton_text}" id="#{id}_save" name="#{id}_save" class="#{savebutton_class}" /> OR <input type="button" value="#{cancelbutton_text}" id="#{id}_cancel" name="#{id}_cancel" class="#{cancelbutton_class}" /> </span><br class="clearall" />',
...
EditInPlace.prototype = {
	...
	_mouseClick: function(e) {
		...
		form += form_buttons.evaluate({
			...
			display_buttons: opt['display_buttons']
		});
