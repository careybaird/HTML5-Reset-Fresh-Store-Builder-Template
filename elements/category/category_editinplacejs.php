<script type="text/javascript">
	...
	$('category-description').editInPlace({form_type: 'textarea', empty_text: '<em>Click to add a description.</em>', save_on_enter: false, display_buttons: 'inherit'});
	$('category-descriptionbottom').editInPlace({form_type: 'textarea', empty_text: '<em>Click to add a description.</em>', save_on_enter: false, display_buttons: 'inherit'});
