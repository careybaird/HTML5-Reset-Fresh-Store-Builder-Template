<script type="text/javascript">
	...
	$('#manufacturer-description').editInPlace({url: save_url, form_type: 'textarea', empty_text: '<em><?=gTT('EDITINPLACE_ADD_DESCRIPTION')?></em>'});
	$('#manufacturer-metadescription').editInPlace({url: save_url, form_type: 'textarea', empty_text: '<em><?=gTT('EDITINPLACE_ADD_METADESCRIPTION')?></em>'});
